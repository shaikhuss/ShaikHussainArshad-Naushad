...
void ShaderTextureLight::SetPointLight3Parameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderTextureLight::SetPointLight4Parameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
	PointLightData4.Light.Ambient = amb;
	PointLightData4.Light.Diffuse = dif;
	PointLightData4.Light.Specular = sp;
	PointLightData4.Position = pos;
	PointLightData4.Attenuation = att;
	PointLightData4.Range = r;
}
